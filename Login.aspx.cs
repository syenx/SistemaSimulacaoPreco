...
using OnConect.Repositorio.Ado;
...
namespace KS.SimuladorPrecos
{
    public partial class Login : System.Web.UI.Page
    {
        ...
        {
            RepositorioFactory.ProviderName = ConfigurationManager.
              ConnectionStrings["defaultConnection"].ProviderName;

            RepositorioFactory.ConnectionString = ConfigurationManager.
        ...
        private void EfetuaLogin()
        {
            try
            {
                ...
                if (oDt.Rows.Count > 0)
                {
                    ...
                    #region Acesso ao menu carga

                    acessoCargaSumulador.usuarioId = userInfo.UserLogin;
                    Session["TipoPerfil"] = acessoCargaSumulador.VerificaAcessoCarga();
                    ...
                    Response.Redirect("~/AppPaginas/Home/Home.aspx", false);
